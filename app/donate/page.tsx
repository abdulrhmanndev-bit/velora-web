...
export default function DonatePage() {
  const offers = [
    { silk: 5500, price: "140 " }, // 2000
    { silk: 4400, price: "112 " }, // 1600
    { silk: 3300, price: "84 " }, // 1200
    { silk: 2200, price: "56 " }, // 800
    { silk: 1100, price: "28 " }, // 400
    { silk: 550, price: "15 " }, // 200
    { silk: 250, price: "8 " }, // 100
    // { silk: 100, price: "3 " }, // 50
  ];
  ...
  const contacts = [
    ...
    },
    {
      ...
      icon: <FaFacebook className="text-[#1877F2] w-7 h-7" />,
    },
  ];
  ...
  return (
    <section className="relative z-10 container mx-auto px-6 py-24 lg:py-40 text-white">
      ...
      <div className="bg-green-900/20 backdrop-blur-md p-8 rounded-2xl shadow-xl max-w-2xl mx-auto mb-16 text-green-400 drop-shadow-[0_0_15px_rgba(25,255,100,0.6)]">
        <h2 className="text-2xl font-bold mb-6 text-center text-green-200">
          Silk Offers
        </h2>
        ...
        <ul className="space-y-4">
          {offers.map((item, idx) => (
            <li
              key={idx}
              className="flex justify-between items-center bg-green-900 p-4 rounded-xl shadow-md hover:scale-105 transition"
            >
              <span className="text-green-100 font-semibold text-2xl">
                {item.silk} Silk
              </span>
        ...
        <h2 className="text-xl font-bold mb-6 text-center text-orange-600">
          Egyptian Players Contact Us Via <Link href={'https://www.facebook.com/profile.php?id=61584111351914'} target="_blank">Facebook</Link> for Silk Donation
        </h2>
        </div>
      {/* Contact Section */}
      <div className="bg-green-900/20 backdrop-blur-md p-8 rounded-2xl shadow-xl max-w-2xl mx-auto text-green-400 drop-shadow-[0_0_15px_rgba(25,255,100,0.4)]">
        ...
        <p className="text-center text-green-100/80 mb-6">
          To complete your donation and receive Silk instantly,
          please contact our team through one of the following:
        </p>
