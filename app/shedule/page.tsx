    ...
    <div className="relative h-screen flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Arena */}
          <motion.div variants={sectionVariants} initial="hidden" animate="visible" transition={{ duration: 0.75 }}>
          ...
          {/* Fortress War */}
          <motion.div variants={sectionVariants} initial="hidden" animate="visible" transition={{ duration: 0.7 }}>
            <Card className="bg-green-950/80 backdrop-blur-sm border-green-700/50 rounded-2xl shadow-form-glow hover:scale-[1.02] transition duration-300 drop-shadow-[0_0_15px_rgba(25,255,100,0.6)]">
              <CardContent className="p-6">
